...
// Updated by eje to use node-sass and bourbon instead of the default ruby sass
'use strict';
  ...
  grunt.initConfig({
    ...
    sass: {
      options: {
        ...
        debugInfo: false,
        lineNumbers: false,
        includePaths: ['app/_bower_components/foundation/scss', 'node_modules/node-bourbon/assets/stylesheets']
      },
      dist: {
        files: [{
          expand: true,
